...
PIG_arsenalWeapons = (PIG_rifles_basic + PIG_pistols + PIG_discard_launchers);
...
PIG_arsenalItems = (PIG_uniforms + PIG_vests + PIG_helmets + PIG_facewears + PIG_rifles_optics + PIG_rail_attach + PIG_rifles_grip + PIG_binos + PIG_ace_commom_tools + PIG_ace_commom_medical_items + PIG_commom_items + PIG_radio + PIG_ace_misc);
