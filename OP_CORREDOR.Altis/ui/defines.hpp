...
// Colors (PiG13BR)
#define COLOR_SPTS {0.372549, 0.00392157, 0.00392157, 1}
#define COLOR_DARK_GRAY { 0.1, 0.1, 0.1, 0.8 }
...
class RscText
{
	...
	SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)"; // To change the size: last number.
	linespacing = 1;
	tooltipColorText[] = 
	{
		1,
